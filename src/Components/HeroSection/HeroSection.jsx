  ...
  return (
    <section className="grid grid-cols-1 lg:grid-cols-2 " >
      <div className="py-10 px-16" >
        <img className="py-5" src={heroDetails.homeImage} alt="heroImage" data-aos="fade-right" data-aos-duration="3000" />
      </div>

      <div className="pt-16" data-aos="fade-left" data-aos-duration="3000" >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 p-10">
          {heroDetails.Homearticle.map((heroDetail) => {
            return (
              <article key={heroDetail.id} className="lg:text-left p-10"  >
