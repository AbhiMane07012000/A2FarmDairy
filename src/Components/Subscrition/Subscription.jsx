...
const Subscription = () => {
  return (
    <section className=" text-black py-12 px-10 text-center md:text-left">
    <div className="container mx-auto flex flex-col md:flex-row items-center">
      <div className="flex-1  md:mb-0">
        ...
        <p className="text-lg md:text-xl" data-aos="fade-right" data-aos-duration="3000">NOW IN PUNE</p>
         <NavLink to="https://wa.link/e1i9xz">
         <button className="bg-cyan-500 hover:bg-cyan-700 text-white font-bold py-3 px-6 my-3 rounded" data-aos="fade-right" data-aos-duration="3000">
          SUBSCRIBE
        </button>
         </NavLink>
